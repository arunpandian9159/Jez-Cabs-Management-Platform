...
export class FilterDriverDto {
  @ApiPropertyOptional({ description: 'Search by name, email, or license number', example: 'John' })
  @IsOptional()
  @IsString()
  search?: string;
  ...
  @ApiPropertyOptional({ description: 'Show only drivers with expiring licenses (within 30 days)', example: true })
  @IsOptional()
  @Type(() => Boolean)
