...
export class TripsService {
    ...
    async acceptTrip(tripId: string, driverId: string, cabId: string): Promise<Trip> {
    ...
    async rateTrip(tripId: string, rating: number, feedback: string, isCustomer: boolean): Promise<Trip> {
        const trip = await this.findOne(tripId);
        if (isCustomer) {
