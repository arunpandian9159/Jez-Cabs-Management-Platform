            ...
            >
                <Card padding="md" className="text-center">
                    <div className="flex items-center justify-center gap-2 mb-1">
                        ...
                        <span className="text-2xl font-bold text-gray-900">{stats.activeContracts}</span>
                    </div>
                ...
                <Card padding="md" className="text-center">
                    <div className="flex items-center justify-center gap-2 mb-1">
                        ...
                        <span className="text-2xl font-bold text-warning-600">{stats.expiringContracts}</span>
                    </div>
                ...
                <Card padding="md" className="text-center">
                    <div className="flex items-center justify-center gap-2 mb-1">
                        ...
                        <span className="text-2xl font-bold text-error-600">{stats.expiredContracts}</span>
                    </div>
