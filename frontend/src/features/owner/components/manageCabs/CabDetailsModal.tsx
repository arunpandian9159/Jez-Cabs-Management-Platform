...
export function CabDetailsModal({ cab, onClose, getDocumentStatusColor }: CabDetailsModalProps) {
    return (
        <Modal
            open={!!cab}
                        ...
                        <div className="border-t pt-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="p-3 bg-primary-50 rounded-lg">
                                    ...
                                    <p className="font-medium text-primary-900">{formatDate(cab.nextService)}</p>
                                </div>
                            </div>
                        </div>
                    </TabsContent>
