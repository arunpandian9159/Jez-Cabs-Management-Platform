            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <Input
                        ...
                        onChange={(e) => onFieldChange('seat_capacity', parseInt(e.target.value) || 4)}
                    />
                </div>
                ...
                <div className="border-t pt-4 mt-4">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <Input
                            ...
                            onChange={(e) => onFieldChange('base_fare', parseInt(e.target.value) || 0)}
                        />
                        <Input
                            label="Per KM Rate (₹)"
                            type="number"
                            ...
                            onChange={(e) => onFieldChange('per_km_rate', parseInt(e.target.value) || 0)}
                        />
                        <Input
                            label="Daily Rate (₹)"
                            type="number"
                            ...
                            onChange={(e) => onFieldChange('daily_rate', parseInt(e.target.value) || 0)}
                        />
                    </div>
                </div>
