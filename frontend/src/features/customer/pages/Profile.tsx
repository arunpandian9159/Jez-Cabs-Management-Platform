    ...
    useEffect(() => {
        const fetchDashboardData = async () => {
            ...
            try {
                ...
                console.warn(
                    'Could not fetch trips (API may not be implemented yet):',
                    error
                );
                setRecentTrips([]);
            }
            ...
            try {
                ...
                console.warn(
                    'Could not fetch saved addresses (API may not be implemented yet):',
                    error
                );
        ...
        >
            ...
            >
                ...
                <div
                    ...
                    style={{
                        background:
                            'linear-gradient(135deg, #0288d1 0%, #0177c6 50%, #ff6b35 100%)',
                    }}
                />
                            ...
                            <Link to={action.path}>
                                ...
                                >
                                    ...
                                    <motion.div
                                        ...
                                        animate={
                                            hoveredAction === action.title ? { x: [0, 4, 0] } : {}
                                        }
                        ...
                        <Card className="bg-white/80 backdrop-blur-sm border-gray-200/50 shadow-sm overflow-hidden">
                            ...
                            <CardContent className="p-0">
                                {savedAddresses.map((address, index) => (
                                    <Link key={address.id} to={ROUTES.CUSTOMER.BOOK_LOCATION}>
                                        <motion.div
