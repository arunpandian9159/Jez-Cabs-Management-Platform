    ...
    return (
        <div className="w-full max-w-lg mx-auto h-full flex flex-col">
            ...
            >
                ...
                <p className="text-gray-500 text-base">Join the Jez Cabs community today</p>
            </motion.div>
            ...
            >
                <div className="flex items-center gap-2.5">
                    <motion.div
                        className={`relative w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold transition-all ${step >= 1 ? 'bg-gradient-to-r from-blue-600 to-teal-500 text-white shadow-lg' : 'bg-gray-200 text-gray-500'
                            }`}
                        animate={{
                ...
                <motion.div
                    className={`w-16 h-1.5 rounded-full transition-all overflow-hidden ${step >= 2 ? 'bg-gradient-to-r from-blue-600 to-teal-500' : 'bg-gray-200'
                        }`}
                    initial={{ scaleX: 0 }}
                    animate={{ scaleX: 1 }}
                ...
                <div className="flex items-center gap-2.5">
                    <motion.div
                        className={`relative w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold transition-all ${step >= 2 ? 'bg-gradient-to-r from-blue-600 to-teal-500 text-white shadow-lg' : 'bg-gray-200 text-gray-500'
                            }`}
                        animate={{
