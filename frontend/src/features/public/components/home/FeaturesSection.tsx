...
function FeatureCard({ feature }: FeatureCardProps) {
  ...
  return (
    ...
    >
      ...
      <div>
        <h4
          className="text-sm sm:text-base lg:text-lg font-semibold mb-0.5 sm:mb-1 lg:mb-2"
          style={{ color: '#0f172a' }}
        >
          {feature.title}
        </h4>
        <p
          className="text-xs sm:text-sm lg:text-base line-clamp-2 sm:line-clamp-none"
          style={{ color: '#475569' }}
        >
          {feature.description}
        </p>
