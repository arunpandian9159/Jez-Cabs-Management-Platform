    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-10 sm:mb-16 lg:mb-20">
          ...
          >
            Whether you need a quick ride or want to rent a cab for days, we've
            got you covered with premium services tailored to your needs
          </p>
        </div>
      ...
      <div
        ...
        onMouseEnter={(e) => {
          ...
          e.currentTarget.style.boxShadow =
            '0 20px 40px rgba(37, 99, 235, 0.15), 0 0 0 1px rgba(37, 99, 235, 0.1)';
        }}
        onMouseLeave={(e) => {
