        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <p
              ...
              style={{ color: '#94a3b8' }}
            >
              Join thousands of happy customers who trust Jez Cabs for safe,
          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-6">
            ...
            >
              ...
              <p
                ...
                style={{ color: '#94a3b8' }}
              >
                Join our network of professional drivers and earn on your own
                schedule.
              </p>
              <button
                onClick={openRegister}
            ...
            >
              ...
              <p
                ...
                style={{ color: '#94a3b8' }}
              >
                Expand your fleet business with our comprehensive management
                tools.
              </p>
              <button
                onClick={openRegister}
