        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            {cancelReasons.map((reason) => (
              <button
                key={reason}
                className={`w-full p-3 text-left rounded-lg border transition-colors ${cancelReason === reason ? 'border-primary-500 bg-primary-50' : 'border-gray-200 hover:bg-gray-50'}`}
