...
export const safetyService = {
  ...
  async createEmergencyContact(
    ...
    return apiClient.post<EmergencyContactApiResponse>(
      '/safety/contacts',
      data
    );
  },
  ...
  async updateEmergencyContact(
    ...
    return apiClient.patch<EmergencyContactApiResponse>(
      `/safety/contacts/${id}`,
      data
    );
  },
  ...
  async shareTrip(
    tripId: string,
    method: 'sms' | 'whatsapp' | 'email' | 'link',
    contactIds?: string[]
  ): Promise<SharedTrip> {
