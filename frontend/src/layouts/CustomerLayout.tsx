                ...
                <div className="p-6 space-y-3">
                  {emergencyOptions.map((option) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`w-12 h-12 rounded-xl ${option.color} flex items-center justify-center text-white`}
                        >
                ...
                <div className="px-6 pb-6 space-y-3">
                    ...
                    >
                      ...
                      <div className="flex gap-3">
                        ...
                        <Button
                          ...
                          fullWidth
                          onClick={() => {
                            const option = emergencyOptions.find(
                              (o) => o.id === selectedEmergency
                            );
                  ...
                  {!isCountdownActive && (
                    <p className="text-xs text-gray-400 text-center">
                      Tap an option to start countdown. Your location will be
