...
export function CustomerDashboard() {
 ...
 interactive
 padding="md"
 className="h-full bg-white border-gray-200 hover:border-primary-300 shadow-sm hover:shadow-lg transition-all"
 >
 <div
 ...
 <Button variant="ghost" size="sm" rightIcon={<ArrowRight className="w-4 h-4" />} className="text-gray-600 hover:text-gray-900">
 View All
 </Button>
 </Link>
 </CardHeader>
 ...
 <CardTitle className="text-lg text-gray-900 ">Saved Addresses</CardTitle>
 </CardHeader>
 <CardContent className="p-0">
