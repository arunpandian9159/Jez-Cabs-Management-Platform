...
export function CabOwnerLayout() {
 ...
 <aside
 className={cn(
 'fixed top-0 left-0 z-50 h-full w-72 bg-white border-r border-gray-200 flex flex-col transition-transform duration-300 lg:translate-x-0 shadow-xl lg:shadow-none',
 ...
 <p className="text-xs text-gray-500 ">Fleet Owner Portal</p>
 </div>
 </Link>
 <button
 onClick={() => setSidebarOpen(false)}
 ...
 <div className="p-3 rounded-xl bg-gradient-to-br from-primary-50 to-primary-100 border border-primary-200 ">
 <div className="flex items-center gap-2 mb-1">
 <Car className="w-4 h-4 text-primary-600 " />
 <span className="text-xs font-medium text-primary-700 ">Cabs</span>
 </div>
 <p className="text-xl font-bold text-primary-900 ">12</p>
 </div>
 <div className="p-3 rounded-xl bg-gradient-to-br from-success-50 to-success-100 border border-success-200 ">
 <div className="flex items-center gap-2 mb-1">
 <TrendingUp className="w-4 h-4 text-success-600 " />
 <span className="text-xs font-medium text-success-700 ">Active</span>
 </div>
 <p className="text-xl font-bold text-success-900 ">8</p>
 </div>
 </div>
 </div>
 ...
 >
 <item.icon className={cn('w-5 h-5', isActive ? 'text-accent-600 ' : '')} />
 {item.name}
 </Link>
 );
 })}
