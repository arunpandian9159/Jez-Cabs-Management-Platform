...
-- =====================================================
-- SAVED ADDRESSES (User's favorite locations)
-- =====================================================
...
CREATE INDEX idx_recent_destinations_user_id ON recent_destinations(user_id);
CREATE INDEX idx_recent_destinations_used_at ON recent_destinations(user_id, used_at DESC);

-- =====================================================
-- USER PAYMENT METHODS (Cards, UPI, etc.)
-- =====================================================
